...
const styles = {
  ...
  leftPanelMobileAddress: 'left-panel-mobile-address flex gap-2 items-center justify-start max-w-[calc(100%-10px)]',
  leftPanelMobileAddressExplorer: 'left-panel-mobile-address-explorer w-[calc(100%-50px)] text-primary text-sm',
