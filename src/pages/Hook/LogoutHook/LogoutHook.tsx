...
import { getLogoutHookData } from 'helpers/sdkDapp/sdkJsWebWalletIo';
import { useLogout, useNavigate } from 'hooks';
import { setHook } from 'redux/slices';
import { HooksEnum, routeNames } from 'routes';
import { CrossWindowProviderResponseEnums } from 'types/sdkDapp';
...
export const LogoutHook = () => {
  ...
  const navigate = useNavigate({ from: 'LogoutHook' });
  const logout = useLogout('LogoutHook');
