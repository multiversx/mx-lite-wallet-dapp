...
describe('Login hook with token test', () => {
  it('should login with token and redirect to the callbackUrl', async () => {
    ...
    await passImpersonateAndChooseAccount();

    expect(page.url()).toMatch(
      `https://devnet.xexchange.com/dashboard?address=${testAccount.address}&signature=80f88acd3326b54d69613a56a50cd1aa74ad6485d4031d92ec2e661253491fc1d933da672251333b2a88f0a18cb486a97764816459953e84dc72700048da0c05`
    );
  });
});
