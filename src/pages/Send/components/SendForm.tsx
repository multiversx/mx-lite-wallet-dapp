...
export interface SendFormProps {
  ...
  canEditNftAmount: boolean;
  formik: ReturnType<typeof useFormik<SendFormType>>;
  handleTypeChange: (
  ...
  isLoading: boolean;
  isNFT: boolean;
  tokenOptions: TokenOptionType[] | undefined;
}
        ...
        <div className='flex flex-row gap-4'>
          <div>
            <input
              ...
              onChange={(event) => handleTypeChange(event, SendTypeEnum.esdt)}
              type='radio'
          ...
          <div>
            <input
              ...
              id={SendTypeEnum.nft}
              name={FormFieldsEnum.type}
              onChange={(event) => handleTypeChange(event, SendTypeEnum.nft)}
              type='radio'
        ...
        <div className='flex flex-row gap-2'>
          ...
          <div className='flex flex-col w-1/2'>
            <Select
              ...
              onBlur={() => formik.setFieldTouched(FormFieldsEnum.token, true)}
            ...
            {formik.touched[FormFieldsEnum.token] &&
              formik.errors[FormFieldsEnum.token] && (
                ...
                >
                  {formik.errors[FormFieldsEnum.token] as string}
                </div>
              )}
          </div>
        </div>
      ...
      <div className='flex flex-col'>
        ...
        <textarea
          ...
          onChange={(event) => {
            ...
            const gasLimit = calculateGasLimit(event.target.value);
